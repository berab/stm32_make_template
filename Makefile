##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.8.0-B50] date: [Wed Feb 11 15:26:10 CET 2026]
##########################################################################################################################
...
C_SOURCES += \
Core/Src/parameters/mnist_d2_l4.c \
Core/Src/nn.c \
Core/Src/models/fff.c \

ifeq ($(TASK),MNIST)
C_SOURCES += Core/Src/datasets/mnist.c
else ifeq ($(TASK),HAR)
C_SOURCES += Core/Src/datasets/har.c 
else ifeq ($(TASK),SC)
C_SOURCES += Core/Src/datasets/sc.c
endif
