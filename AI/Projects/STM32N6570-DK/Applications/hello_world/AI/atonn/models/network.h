...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "mnist_int8_io_i8"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (784)

/************************** OUTPUTS *******************************************/
#define LL_ATON_DEFAULT_OUT_NUM        (1)    // Total number of output buffers
// Output buffer 1 -- Quantize_14_out_0
