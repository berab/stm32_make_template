/**
  ******************************************************************************
  * @file    PWR/PWR_STANDBY_TrustZone/App_Secure/Inc/partition_stm32n657xx.h
  * @author  GPM Application Team
  * @brief   CMSIS STM32N657xx Device Initial Setup for Secure / Non-Secure Zones
  *          for ARMCM55 based on CMSIS CORE V5.8.0 partition_ARMCM55.h Template.
  *
  *          This file contains:
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START0     0x70100000      /* start address of SAU region 0 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END0       0x7017FFFF      /* end address of SAU region 0 */
#elif defined(__GNUC__)
...
#else
/* otherwise, manually set SAU region */
/*
//     <o>Start Address <0-0xFFFFFFE0>
*/
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START1     0x20000000/*0x00000000*/      /* start address of SAU region 1 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END1       0x2FFFFFFF      /* end address of SAU region 1 */
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START3     0x70180000      /* start address of SAU region 3 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END3       0x7FFFFFFF      /* end address of SAU region 3 */
...
*/
#define NVIC_INIT_ITNS0_VAL     0x00010000
...
*/
#define NVIC_INIT_ITNS1_VAL     0x03E00000
