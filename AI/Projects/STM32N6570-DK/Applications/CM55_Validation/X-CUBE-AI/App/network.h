...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "fff_uint8_v1"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xc6dcec9d7e85dcb0e884c7b534488e1f"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x0723b52e5d04112a)
...
#define STAI_NETWORK_NODES_NUM           (4)

/*  Macro to declare number macc for generated network model  */
#define STAI_NETWORK_MACC_NUM            (424795)
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,40}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_CHANNEL     (40)
#define STAI_NETWORK_OUT_1_RANK        (1)
#define STAI_NETWORK_OUT_1_SIZE        ((40))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (40)
#define STAI_NETWORK_OUT_1_SCALE       (0.006029282230883837f)
#define STAI_NETWORK_OUT_1_ZERO_POINT  (-32)
...
#define STAI_NETWORK_OUT_2_SHAPE       {1,3}
#define STAI_NETWORK_OUT_2_BATCH       (1)
#define STAI_NETWORK_OUT_2_CHANNEL     (3)
#define STAI_NETWORK_OUT_2_RANK        (1)
#define STAI_NETWORK_OUT_2_SIZE        ((3))
#define STAI_NETWORK_OUT_2_SIZE_BYTES  (3)
#define STAI_NETWORK_OUT_2_SCALE       (0.013232775032520294f)
#define STAI_NETWORK_OUT_2_ZERO_POINT  (-7)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (3360)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (3360)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (3360)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (3360)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (426460)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (426460)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (426460)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (426460)
